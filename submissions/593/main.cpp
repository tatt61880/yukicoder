...
static void k_ba(type_(Array_<char16_t>) k_ev /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_be(T_ k_ew /*me_*/, type_(Array_<int64_t>) k_ex /*type*/);
template<typename T_>static T_ k_cq(T_ k_ey /*me_*/, type_(Array_<int64_t>) k_ez /*type*/, T_ k_fa /*n*/);
template<typename T_>static T_ k_cr(T_ k_fb /*me_*/, type_(Array_<int64_t>) k_fc /*type*/, int64_t k_fd /*n*/);
template<typename T_>static T_ k_dd(T_ k_fg /*me_*/, type_(Array_<int64_t>) k_fh /*type*/, int64_t k_fi /*n*/);
static char16_t k_eh();
template<typename T_>static T_ k_eu(T_ k_fl /*me_*/, type_(Array_<int64_t>) k_fm /*type*/, int64_t k_fn /*start*/, int64_t k_fo /*len*/);
...
(k_av) = ((static_cast<int64_t>((k_am)->At(k_at))) - (48LL));
(k_ao) = ((k_ao) + (k_av));
(k_ap) = ((k_ap) + (((((k_at) % (2LL)) == (0LL)) ? (1LL) : (-1LL)) * (k_av)));
}
if((((k_ao) % (3LL)) == (0LL)) && (((k_ap) % (5LL)) == (0LL))){
(k_ba)((newArrayBin_<char16_t>(9,"\x46\x00\x69\x00\x7A\x00\x7A\x00\x42\x00\x75\x00\x7A\x00\x7A\x00\x0A\x00")));
}
else if(((k_ap) % (5LL)) == (0LL)){
(k_ba)((newArrayBin_<char16_t>(5,"\x42\x00\x75\x00\x7A\x00\x7A\x00\x0A\x00")));
}
else if(((k_ao) % (3LL)) == (0LL)){
(k_ba)((newArrayBin_<char16_t>(5,"\x46\x00\x69\x00\x7A\x00\x7A\x00\x0A\x00")));
}
else{
(k_ba)((((newArrayBin_<char16_t>(0,""))->Cat(k_be<type_(Array_<char16_t>)>((k_am), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
}
// _finVars
static void k_i(){
...
// input
static type_(Array_<char16_t>) k_an(){
type_(Array_<char16_t>) k_eb; // buf
int64_t k_ec; // ptr
char16_t k_eg; // c
(k_eb) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_ec) = (0LL);
while(true){
(k_eg) = ((k_eh)());
if((k_eg) == (u'\u000D')){
...
if((k_ec) == ((k_eb)->Len())){
(k_eb) = ((k_eb)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_eb)->Len()))));
}
((k_eb)->At(k_ec)) = (k_eg);
(k_ec) = ((k_ec) + (1LL));
}
return k_eu<type_(Array_<char16_t>)>((k_eb), (nullptr), (0LL), (k_ec));
}
// print
static void k_ba(type_(Array_<char16_t>) k_ev /*str*/){
if(k_ev==nullptr){
